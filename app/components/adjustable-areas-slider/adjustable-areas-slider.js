var SlidersView = Em.ContainerView.extend(), //
	...
	AdjustableAreasSliderComponent = Em.Component.extend({
	...
	SliderAreaController = Em.Object.extend({
		content: null,
		...
		minutes: Em.computed.alias('content.minutes'),
		color: Em.computed.alias('content.color'),
...
AdjustableAreasSliderComponent.reopenClass({
	defaultColors: [
		"DarkSalmon",
		"FireBrick",
		"Gold",
...
export default AdjustableAreasSliderComponent;